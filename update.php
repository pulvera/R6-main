            ...
            <form action="process.php" method="POST">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="studentId" name="student_number">
                    </div>
                    ...
                    <div class="col-md-12 mb-3 text-center">
                        <button type="submit" class="btn btn-primary" name="updateButton" style="float: right;">Submit</button>
                    </div>
                </div>
            </form>
        </div>
