          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <a type="button" class="btn btn-primary" name="viewButton" href="view.php?id=<?=$row['id'];?>">VIEW</a>
                <a type="button" class="btn btn-warning" name="updateButton" href="update.php?id=<?=$row['id'];?>">UPDATE</a>
